...
namespace Microsoft.Research.MultiWorldTesting.ExploreLibrary
{
    ...
    public class MwtExplorer<TContext, TAction, TExplorerState, TPolicyAction, TPolicyState>
	{
        private ulong appId;
        private IRecorder<TContext, TAction, TExplorerState, TPolicyAction, TPolicyState> recorder;
        ...
        public MwtExplorer(string appId, IRecorder<TContext, TAction, TExplorerState, TPolicyAction, TPolicyState> recorder)
		{
        ...
        public TAction ChooseAction(IExplorer<TContext, TAction, TExplorerState, TPolicyAction, TPolicyState> explorer, UniqueEventID uniqueKey, TContext context, uint numActionsVariable = uint.MaxValue)
        {
        ...
        /// <param name="numActionsVariable">Optional; Number of actions available which may be variable across decisions.</param>
        /// <returns>An unsigned 32-bit integer representing the 1-based chosen action.</returns>
        public TAction ChooseAction(IExplorer<TContext, TAction, TExplorerState, TPolicyAction, TPolicyState> explorer, string uniqueKey, TContext context, uint numActionsVariable = uint.MaxValue)
        {
