...
namespace Microsoft.Research.MultiWorldTesting.ExploreLibrary
{
    ...
    /// </remarks>
    public interface IRecorder<TContext, TAction, TExplorerState, TPolicyState>
    {
        /// <summary>
        ...
        void Record(TContext context, Decision<TAction, TExplorerState, TPolicyState> decision, UniqueEventID uniqueKey); // string modelId = null, bool? isExplore = null
    };

    public interface IExplorer<TContext, TAction, TExplorerState, TPolicyState>
    {
        /// <summary>
        ...
        /// </returns>
        Decision<TAction, TExplorerState, TPolicyState> ChooseAction(ulong saltedSeed, TContext context, uint numActionsVariable = uint.MaxValue);

        void EnableExplore(bool explore);
    };

    public interface IPolicy<TContext, TAction, TPolicyState>
    {
        /// <summary>
...
namespace Microsoft.Research.MultiWorldTesting.ExploreLibrary.MultiAction
{
    ...
    public interface IExplorer<TContext, TAction>
    {
        /// <summary>
        /// Determines the action to take and the probability with which it was chosen, for a
        /// given context. 
        ...
        /// and a flag indicating whether to record this decision.
        /// </returns>
        Decision<TAction> ChooseAction(ulong saltedSeed, TContext context, uint numActionsVariable = uint.MaxValue);
