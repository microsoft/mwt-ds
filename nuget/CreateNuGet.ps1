...
..\.nuget\nuget pack ..\ClientDecisionService\ClientDecisionService.nuspec -Version $version -Prop "Configuration=Release;Platform=x64" -Prop "SolutionDir=..\" -OutputDirectory $outputDirectory
