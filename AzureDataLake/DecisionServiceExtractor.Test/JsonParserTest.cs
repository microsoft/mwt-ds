    ...
    public class JsonParserTest
    {
        ...
        public void ActionCountTest()
        {
            ...
            using (var stream = new MemoryStream(Encoding.UTF8.GetBytes(example)))
            {
                ...
                {
                    Assert.AreEqual(output.Get<int>("NumActions"), 9);
                }
            }
        }
    }
