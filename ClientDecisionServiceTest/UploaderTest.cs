...
namespace ClientDecisionServiceTest
{
    ...
    public class UploaderTest
    {
        ...
        public void TestUploaderSingleEvent()
        {
            ...
            uploader.Upload(new Interaction { Value = 1, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.5, Key = uniqueKey });
            uploader.Upload(new Interaction { Value = new uint[] { 1 }, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.5, Key = uniqueKey });
            uploader.Flush();
        ...
        public void TestUploaderMultipleEvents()
        {
            ...
            uploader.Upload(new Interaction { Value = 1, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.5, Key = uniqueKey });
            uploader.Upload(new Interaction { Value = 2, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.7, Key = uniqueKey });
            uploader.Upload(new Interaction { Value = 0, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.5, Key = uniqueKey });

            uploader.Upload(new Interaction { Value = new uint[] { 1 }, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.5, Key = uniqueKey });
            uploader.Upload(new Interaction { Value = new uint[] { 2 }, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.7, Key = uniqueKey });
            uploader.Upload(new Interaction { Value = new uint[] { 0 }, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = 0.5, Key = uniqueKey });
        ...
        public void TestUploaderThreadSafeMock()
        {
            ...
            {
                uploader.Upload(new Interaction { Value = (uint)i, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = i / 1000.0, Key = uniqueKey });
                uploader.Upload(new Interaction { Value = new uint[] { (uint)i }, Context = JsonConvert.SerializeObject(new TestContext()), ExplorerState = i / 1000.0, Key = uniqueKey });
