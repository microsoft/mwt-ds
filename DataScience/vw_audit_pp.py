...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output', type=str, help="output file that captures audit in a tabular format in TSV format.", required=True)
    parser.add_argument('-d', '--debug', type=str, required=False, help="advanced printing for debugging", default=False)
