...
if __name__ == '__main__':
    ...
    for do_by_day in [False, True]:    
        ...
        if do_by_day:
            # IPS traffic plot
            p = [(y[0], y[1][0]/max(y[1][1],1)) for y in pStats_ips]
        ...
        legend = axarr[0].legend(loc=legend_loc)
        legend = axarr[1].legend(loc=legend_loc)
        legend = axarr[2].legend(loc=legend_loc)
